...
public class EventGroup {
	...
	public EventGroup(String id, String name, String displayOrder, String eventClassId) {
	...
	public static Key generateKeyFromID(String id) {
		...
		return KeyFactory.createKey(EventGroup.class.getSimpleName(), "id" + id);
	}
	...
	public String toString() {
		...
		return "G:(" + id + ',' + name + ',' + displayOrder + ',' + eventClassId + ")";
	}
