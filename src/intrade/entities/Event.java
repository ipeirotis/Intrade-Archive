...
public class Event {
	...
	public Event(String id, String groupId, String name, String displayOrder, String description, Long startDate,
			Long endDate) {
	...
	public String toString() {
		...
		return "E:(" + id + ',' + groupId + ',' + name + ',' + displayOrder + ',' + description + ',' + startDate + ','
				+ endDate + ")";
	}
